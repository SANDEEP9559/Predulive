        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <div class="blog-img-inner">
                            <img class="img-fluid w-100 rounded-top" src="img/package-9.jpg" alt="Image">
                            <div class="blog-icon">
                                <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        ...
                        <a href="#" class="h4">Innovation Infrastructure</a>
                        <p class="my-3">Access cutting-edge innovation infrastructure through our coworking spaces and technology hubs, fostering a culture of creativity and collaboration.</p>
                        <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    ...
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        ...
                        <a href="#" class="h4">Community Building</a>
                        <p class="my-3">Become part of a thriving entrepreneurial community through our community-building initiatives, including conferences, events, and local networks.</p>
                        <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                    </div>
                </div>
            </div>
