                ...
                <div class="packages-carousel owl-carousel">
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-1.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Consulting Services</h5>
                                <p class="mb-4">Our consulting services offer personalized guidance on business strategy, legal compliance, and market entry, ensuring startups have the support they need to thrive.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-2.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                ...
                                <p class="mb-4"><br>Empower your team with our training programs, designed to enhance skills and prepare startups for the challenges of the business world.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-3.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Incubation Services</h5>
                                <p class="mb-4"><br>Benefit from our incubation services, providing startups with physical space, resources, and mentorship to accelerate their growth.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-4.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Networking & Partnerships:</h5>
                                <p class="mb-4"><br>Forge valuable connections with our networking and partnerships services, facilitating collaborations with industry experts and fellow entrepreneurs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-5.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0"><br><br>Online Monetization</h5>
                                <p class="mb-4">Explore online monetization opportunities through our platform, connecting startups, investors, and mentors for mutual growth.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-6.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Startup Support</h5>
                                <p class="mb-4"><br>Join our startup support program for guidance, mentorship, and access to resources that will propel your venture forward.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-7.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Funding Access</h5>
                                <p class="mb-4"><br>Navigate the funding landscape with our assistance, connecting startups with government grants, schemes, and potential investors.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-8.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Capacity Building</h5>
                                <p class="mb-4"><br>Participate in our capacity-building programs, including workshops and bootcamps, to enhance your skills and knowledge.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-9.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Innovation Infrastructure</h5>
                                <p class="mb-4"><br>Access cutting-edge innovation infrastructure through our coworking spaces and technology hubs, fostering a culture of creativity and collaboration.</p>
                            </div>
                        </div>
                    </div>
                    <div class="packages-item">
                        <div class="packages-img">
                            <img src="img/package-10.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                            <div class="packages-info d-flex border border-start-0 border-end-0 position-absolute" style="width: 100%; bottom: 0; left: 0; z-index: 5;">  
                            </div>
                        ...
                        <div class="packages-content bg-light">
                            <div class="p-4 pb-0">
                                <h5 class="mb-0">Community Building</h5>
                                <p class="mb-4"><br>Become part of a thriving entrepreneurial community through our community-building initiatives, including conferences, events, and local networks.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                        ...
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/Seema Dwivedi (Leadership Team).png" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/Shivanshu.png" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Shivanshu Dwivedi </h4>
                                    <p class="mb-0">Designation</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            <div class="guide-img">
                                <div class="guide-img-efects">
                                    <img src="img/mahima.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                                </div>
                                <div class="guide-icon rounded-pill p-2">
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square btn-primary rounded-circle mx-1" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="guide-item">
                            ...
                            <div class="guide-title text-center rounded-bottom p-4">
                                <div class="guide-title-inner">
                                    <h4 class="mt-3">Sandeep Kumar</h4>
                                    <p class="mb-0">Designation</p>
                                </div>
                            </div>
                        </div>
